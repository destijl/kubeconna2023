...
kubectl wait clusterrolebinding.rbac.authorization.k8s.io/bad-clusterrole-binding-anonymous --for=delete --timeout=-1s
...
kubectl wait clusterrolebinding.rbac.authorization.k8s.io/bad-clusterrole-binding-unauthenticated --for=delete --timeout=-1s
...
kubectl wait clusterrolebinding.rbac.authorization.k8s.io/bad-clusterrole-binding-authenticated --for=delete --timeout=-1s
...
kubectl wait rolebinding.rbac.authorization.k8s.io/bad-role-binding-anonymous --for=delete --timeout=-1s
...
kubectl wait rolebinding.rbac.authorization.k8s.io/bad-role-binding-unauthenticated --for=delete --timeout=-1s
